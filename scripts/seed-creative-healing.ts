...
const WEEKS: SeedWeek[] = [
  ...
  // Week 1 — Safety
  {
    ...
    components: [
      { componentType: 'reflection_journal', title: 'Blurts → Affirmations', config: { prompt: 'This week, work with your affirmations of choice and your blurts at the end of each day\'s morning pages. Convert all negative blurts into positive affirmations. Example: "I\'m stupid" → "I\'m always learning"', minWords: 0, saveEnabled: true } },
  ...
  // Week 2 — Identity
  {
    ...
    components: [
      ...
      { componentType: 'text_input', title: 'Daily Affirmations', config: { placeholder: 'Write three chosen affirmations five times each day in your morning pages', inputType: 'text', maxLength: 500, labels: ['Chosen Affirmation 1', 'Chosen Affirmation 2', 'Chosen Affirmation 3'], multiple: true } },
