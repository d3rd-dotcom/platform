...
/**
 * @title Diamonds ($BLUE)
 * @notice Mental Wealth Academy's reputation token. Diamonds are earned in the
 *         Academy (course missions, tasks, field notes, quests) and delivered
 *         onchain so users own their record.
 *
