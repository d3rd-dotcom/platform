...
def generate_report():
    ...
    try:
        ...
        # Pre-generate report_id so it can be returned to frontend immediately
        import uuid
...
def chat_with_report_agent():
    ...
    Report Agent can autonomously invoke retrieval tools in conversation to answer questions
...
def get_report_sections(report_id: str):
    ...
    Frontend can poll this API to get generated section content without waiting for the entire report to complete
...
def get_agent_log(report_id: str):
    ...
    Query parameters:
        from_line: Starting line number (optional, default 0, for incremental fetching)
...
def get_console_log(report_id: str):
    ...
    unlike the structured JSON logs returned by the agent-log API,
