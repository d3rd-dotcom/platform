...
This module wraps the auto-paging logic (with per-page retry),
...
def fetch_all_nodes(
    ...
    """Fetch graph nodes with pagination, returning at most max_items (default 2000). Each page request has built-in retry."""
    all_nodes: list[Any] = []
