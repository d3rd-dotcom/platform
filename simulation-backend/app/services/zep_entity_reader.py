...
Reads nodes from Zep graph and filters those matching predefined entity types
"""
...
class ZepEntityReader:
    ...
    def _call_with_retry(
        ...
        Args:
            ...
            max_retries: Maximum retry attempts (default 3, i.e., up to 3 total attempts)
    ...
    def get_node_edges(self, node_uuid: str) -> List[Dict[str, Any]]:
        ...
        """
        try:
            # Use retry mechanism for Zep API call
    ...
    def filter_defined_entities(
        ...
        - If a node's Labels include labels beyond "Entity" and "Node", it matches predefined types, keep it
        ...
        for node in all_nodes:
            ...
            # Filtering logic: Labels must include labels beyond "Entity" and "Node"
            ...
            # If predefined types are specified, check for matches
    ...
    def get_entity_with_context(
        ...
        """
        Get a single entity with its full context (edges and associated nodes, with retry mechanism)
