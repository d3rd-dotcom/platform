...
1. InsightForge (Deep Insight Retrieval) - Most powerful hybrid retrieval, automatically generates sub-queries and performs multi-dimensional search
...
class InsightForgeResult:
    ...
    def to_text(self) -> str:
        ...
        text_parts = [
            ...
            f"- Related prediction facts: {self.total_facts} entries",
            f"- Entities involved: {self.total_entities} entities",
            f"- Relationship chains: {self.total_relationships} chains"
        ]
        ...
        if self.entity_insights:
            ...
            for entity in self.entity_insights:
                ...
                if entity.get('related_facts'):
                    text_parts.append(f"  Related facts: {len(entity.get('related_facts', []))} entries")
...
class PanoramaResult:
    ...
    def to_text(self) -> str:
        ...
        text_parts = [
            ...
            f"- Currently active facts: {self.active_count} entries",
            f"- Historical/expired facts: {self.historical_count} entries"
        ]
...
class ZepToolsService:
    ...
    - get_entity_summary - Get relationship summary of an entity
    """
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Retrieves all edges in the graph, then filters for edges related to the specified node
    ...
    def insight_forge(
        ...
        The most powerful hybrid retrieval function, automatically decomposes questions and performs multi-dimensional search:
        ...
        entity_insights = []
        node_map = {}  # Used for relationship chain building later
...
Return a JSON-formatted list of sub-questions."""
    ...
    def panorama_search(
        ...
        3. Categorize and organize current active and historical information

        This tool is suitable for scenarios where you need to understand the full picture of events and track evolution processes.
    ...
    def interview_agents(
        ...
        if not profiles:
            ...
            result.summary = "No Agent profile files found for interviewing"
            return result
        ...
        INTERVIEW_PROMPT_PREFIX = (
            ...
            "5. Separate each question's answer with a blank line\n"
        ...
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Clean response text: remove markers, numbering, Markdown and other interference
                ...
                # Strategy 2 (Supplementary): Correctly paired Chinese quotation marks with long text inside
                if not key_quotes:
...
- Use plain text paragraphs, separated by blank lines for different sections
- Do not use Markdown headings (such as #, ##, ###)
- Do not use dividers (such as ---, ***)
- Use quotation marks when citing interviewee original words
