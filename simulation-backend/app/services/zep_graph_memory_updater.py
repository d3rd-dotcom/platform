...
class ZepGraphMemoryUpdater:
    ...
    Groups by platform and sends in batches of BATCH_SIZE to Zep.

    All meaningful behaviors are updated to Zep, with action_args containing full context:
    ...
    # Send interval (seconds), to avoid sending too quickly
    SEND_INTERVAL = 0.5
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args contains full context information (such as post text, usernames, etc.).
                ...
                try:
                    ...
                    with self._buffer_lock:
                        ...
                        if len(self._platform_buffers[platform]) >= self.BATCH_SIZE:
                            ...
                            # Send interval to avoid sending too quickly
...
class ZepGraphMemoryManager:
    ...
    def get_updater(cls, simulation_id: str) -> Optional[ZepGraphMemoryUpdater]:
        """Get simulation's updater"""
        return cls._updaters.get(simulation_id)

    @classmethod
    def stop_updater(cls, simulation_id: str):
        """Stop and remove simulation's updater"""
        with cls._lock:
            if simulation_id in cls._updaters:
                cls._updaters[simulation_id].stop()
