...
CHINA_TIMEZONE_CONFIG = {
    ...
    "activity_multipliers": {
        "dead": 0.05,      # Almost nobody in the early morning
...
class AgentActivityConfig:
    ...
    # Influence weight (determines the probability of posts being seen by other Agents)
...
class PlatformConfig:
    ...
    # Viral spread threshold (interactions needed to trigger spreading)
...
class SimulationConfigGenerator:
    ...
    def _build_context(
        ...
        remaining_length = self.MAX_CONTEXT_LENGTH - current_length - 500  # Reserve 500 characters margin
...
- The user base consists of Chinese users; the schedule should follow Beijing Time daily routines
- Midnight 0-5 AM: almost no activity (activity multiplier 0.05)
...
- General pattern: low activity at dawn, gradually increasing in the morning, moderate during work hours, peak in the evening
- **Important**: The example values below are for reference only; you should adjust specific time periods based on the nature of the event and characteristics of the participant groups
  - For example: student groups may peak at 9-11 PM; media are active all day; official organizations only during work hours
  - For example: breaking news may cause discussion even late at night; off_peak_hours can be shortened accordingly
...
- reasoning (string): Brief explanation of why this configuration was chosen"""
        ...
        system_prompt = "You are a social media simulation expert. Return pure JSON format. The time configuration should follow Chinese daily schedule patterns. Respond in English."
    ...
    def _parse_time_config(self, result: Dict[str, Any], num_entities: int) -> TimeSimulationConfig:
        ...
        return TimeSimulationConfig(
            ...
            off_peak_activity_multiplier=0.05,  # Almost nobody in early morning
...
{{
    ...
    "reasoning": "<brief explanation>"
        ...
        system_prompt = "You are a public opinion analysis expert. Return pure JSON format. The poster_type must exactly match the available entity types. Respond in English."
    ...
    def _assign_initial_post_agents(
        ...
        # Type mapping table (handles different formats the LLM may output)
        type_aliases = {
...
- **Schedule follows Chinese daily routines**: almost no activity from midnight to 5 AM, most active from 7-10 PM
...
{{
    "agent_configs": [
        {{
            ...
            "active_hours": [<active hours list, following Chinese daily schedule>],
        ...
        system_prompt = "You are a social media behavior analysis expert. Return pure JSON. Configurations should follow Chinese daily schedule patterns. Respond in English."
