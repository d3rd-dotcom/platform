...
Implements a simple command/response pattern through the filesystem:
...
class SimulationIPCClient:
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: In dual-platform simulation, interview both; in single-platform, interview that platform
            timeout: Timeout
    ...
    def check_env_alive(self) -> bool:
        ...
        Checks by reading the env_status.json file
        """
...
class SimulationIPCServer:
    ...
    def poll_commands(self) -> Optional[IPCCommand]:
        """
        Poll commands directory, return the first pending command
