...
const WEEKLY_READINGS = [
  ...
  { title: 'A Sense of Safety', author: '', description: 'Establish a foundation of safety to explore your creativity without fear.', category: 'Week 1', imageUrl: '/stories/week-01/creative-recovery-butterflies.png', slug: 'sense-of-safety', markdownPath: '/readings/sense-of-safety.md' },
  { title: 'A Sense of Identity', author: '', description: 'The gap between human perception and machine processing. What lives in that space, and how to close it.', category: 'Week 2', imageUrl: '/stories/week-01/blue-research-log.png', slug: 'sense-of-identity', markdownPath: '/readings/sense-of-identity.md' },
  { title: 'A Sense of Power', author: '', description: 'Anger, shame, and useful signals surface here. This week asks you to reclaim your power and act on it.', category: 'Week 3', imageUrl: '/stories/week-01/shadow-breaking-free.png', slug: 'sense-of-power', markdownPath: '/readings/sense-of-power.md' },
  { title: 'A Sense of Integrity', author: '', description: 'Align your actions with your deepest values. Integrity is the bridge between vision and reality.', category: 'Week 4', imageUrl: '/stories/week-01/shadow-breaking-free.png', slug: 'sense-of-integrity', markdownPath: '/readings/sense-of-integrity.md' },
  { title: 'A Sense of Possibility', author: '', description: 'Dismantle the limits you inherited. Possibility is not given — it is reclaimed.', category: 'Week 5', imageUrl: '/stories/week-01/trapped-shade-chamber.png', slug: 'sense-of-possibility', markdownPath: '/readings/sense-of-possibility.md' },
  ...
  { title: 'A Sense of Connection', author: '', description: 'Creativity is not solitary. Learn to receive support and give it without losing yourself.', category: 'Week 7', imageUrl: '/stories/week-01/healer-creative-reflection.png', slug: 'sense-of-connection', markdownPath: '/readings/sense-of-connection.md' },
