      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          ...
          <button type="button" onClick={openCourseBuilder} className={styles.buildCard}>
            ...
            <span className={styles.buildLabel}>Build your own</span>
            <span className={styles.buildSub}>Blue generates a 4-week course around anything you want to learn.</span>
          </button>
        </div>
      </main>
    </div>
