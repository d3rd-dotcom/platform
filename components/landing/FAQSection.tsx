...
const FAQ_ITEMS = [
  ...
  {
    question: 'How do I exchange my credits for cash?',
    answer:
      'Users exchange credits for cash through our partners at Coinbase Exchange. When a redemption campaign is open, eligible credits can be converted into USDC or another supported payout asset and sent to a connected Coinbase account or compatible wallet. Redemption rates, minimum balances, availability, and identity checks may vary by campaign and partner requirements.',
  },
  {
