      ...
      <div className={styles.heroSection}>
        <div className={styles.heroContent}>
          ...
          <div className={styles.heroActions}>
            ...
            >
              <svg className={styles.githubBadgeLogo} viewBox="0 0 438.549 438.549" aria-hidden="true">
              ...
              <span className={styles.heroSlideWrap}>
                <span className={styles.heroSlideText}>Star on GitHub</span>
                <span className={`${styles.heroSlideText} ${styles.heroSlideClone}`}>Star on GitHub</span>
              </span>
              <span className={styles.githubBadgeDivider} aria-hidden="true" />
              <svg className={styles.githubBadgeStar} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <span className={styles.githubBadgeCount}>6</span>
            </a>
          </div>
        </div>
