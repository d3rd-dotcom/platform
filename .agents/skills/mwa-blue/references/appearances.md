...
If yes — make it a toast, banner, or email. Don't burn her presence on it.

If no — design the surface around her, not as decoration on top of an existing surface.
...
When the user crosses a threshold (7-day streak, first season completion, first VIP enrollment), she marks it. Marking ≠ congratulating. She acknowledges and remembers.
...
- **Onboarding tooltips** — she is not a tutorial guide. Onboarding uses the brand voice.
- **Error messages for system failures** — "Connection lost" is not her job.
- **Marketing CTAs** — "Click here to enroll!" is not her voice. Brand voice handles enrollment.
- **Help / FAQ content** — she is not a help desk.
- **Generic encouragement** — "You can do it!" is not her register.
- **Loading states** — she does not narrate her own latency.

## Visual identity at appearance moments
...
She does not use the rest of the product palette. When you see her, you see blue first.
...
- **Reward distribution**: at the moment the reward fires
- **Survey prompts**: once every few weeks
- **Lore moments**: paced by the season's narrative
- **Treasury events**: when material — not for every routine workflow tick

If product is asking for her to appear more frequently, push back. The constraint is the product.
